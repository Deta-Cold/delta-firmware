...
///     """
STATIC mp_obj_t mod_detahardio_FatFSFile___exit__(size_t n_args,
                                                const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mod_detahardio_FatFSFile___exit___obj,
                                           4, 4,
                                           mod_detahardio_FatFSFile___exit__);

/// def close(self) -> None:
///     """
///     Close an open file object
///     """
STATIC mp_obj_t mod_detahardio_FatFSFile_close(mp_obj_t self) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardio_FatFSFile_close_obj,
                                 mod_detahardio_FatFSFile_close);

/// def read(self, data: bytearray) -> int:
///     """
///     Read data from the file
///     """
STATIC mp_obj_t mod_detahardio_FatFSFile_read(mp_obj_t self, mp_obj_t data) {
  mp_obj_FatFSFile_t *o = MP_OBJ_TO_PTR(self);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardio_FatFSFile_read_obj,
                                 mod_detahardio_FatFSFile_read);

/// def write(self, data: bytes | bytearray) -> int:
///     """
///     Write data to the file
///     """
STATIC mp_obj_t mod_detahardio_FatFSFile_write(mp_obj_t self, mp_obj_t data) {
  mp_obj_FatFSFile_t *o = MP_OBJ_TO_PTR(self);
  mp_buffer_info_t buf = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardio_FatFSFile_write_obj,
                                 mod_detahardio_FatFSFile_write);

/// def seek(self, offset: int) -> None:
///     """
///     Move file pointer of the file object
///     """
STATIC mp_obj_t mod_detahardio_FatFSFile_seek(mp_obj_t self, mp_obj_t offset) {
  mp_obj_FatFSFile_t *o = MP_OBJ_TO_PTR(self);
  FSIZE_t ofs = detahard_obj_get_uint(offset);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardio_FatFSFile_seek_obj,
                                 mod_detahardio_FatFSFile_seek);

/// def truncate(self) -> None:
///     """
///     Truncate the file
///     """
STATIC mp_obj_t mod_detahardio_FatFSFile_truncate(mp_obj_t self) {
  mp_obj_FatFSFile_t *o = MP_OBJ_TO_PTR(self);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardio_FatFSFile_truncate_obj,
                                 mod_detahardio_FatFSFile_truncate);

/// def sync(self) -> None:
///     """
///     Flush cached data of the writing file
///     """
STATIC mp_obj_t mod_detahardio_FatFSFile_sync(mp_obj_t self) {
  mp_obj_FatFSFile_t *o = MP_OBJ_TO_PTR(self);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardio_FatFSFile_sync_obj,
                                 mod_detahardio_FatFSFile_sync);

STATIC const mp_rom_map_elem_t mod_detahardio_FatFSFile_locals_dict_table[] = {
    {MP_ROM_QSTR(MP_QSTR___enter__), MP_ROM_PTR(&mp_identity_obj)},
    {MP_ROM_QSTR(MP_QSTR___exit__),
     MP_ROM_PTR(&mod_detahardio_FatFSFile___exit___obj)},
    {MP_ROM_QSTR(MP_QSTR_close), MP_ROM_PTR(&mod_detahardio_FatFSFile_close_obj)},
    {MP_ROM_QSTR(MP_QSTR_read), MP_ROM_PTR(&mod_detahardio_FatFSFile_read_obj)},
    {MP_ROM_QSTR(MP_QSTR_write), MP_ROM_PTR(&mod_detahardio_FatFSFile_write_obj)},
    {MP_ROM_QSTR(MP_QSTR_seek), MP_ROM_PTR(&mod_detahardio_FatFSFile_seek_obj)},
    {MP_ROM_QSTR(MP_QSTR_truncate),
     MP_ROM_PTR(&mod_detahardio_FatFSFile_truncate_obj)},
    {MP_ROM_QSTR(MP_QSTR_sync), MP_ROM_PTR(&mod_detahardio_FatFSFile_sync_obj)},
};
STATIC MP_DEFINE_CONST_DICT(mod_detahardio_FatFSFile_locals_dict,
                            mod_detahardio_FatFSFile_locals_dict_table);

STATIC const mp_obj_type_t mod_detahardio_FatFSFile_type = {
    {&mp_type_type},
    .name = MP_QSTR_FatFSFile,
    .locals_dict = (void *)&mod_detahardio_FatFSFile_locals_dict,
};
...
///     """
STATIC mp_obj_t mod_detahardio_FatFSDir_iternext(mp_obj_t self) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardio_FatFSDir_iternext_obj,
                                 mod_detahardio_FatFSDir_iternext);

STATIC const mp_obj_type_t mod_detahardio_FatFSDir_type = {
    {&mp_type_type},
    .name = MP_QSTR_FatFSDir,
    .getiter = mp_identity_getiter,
    .iternext = mod_detahardio_FatFSDir_iternext,
};
...
///     """
STATIC mp_obj_t mod_detahardio_fatfs_open(mp_obj_t path, mp_obj_t flags) {
  FATFS_ONLY_MOUNTED;
  ...
  mp_obj_FatFSFile_t *f =
      mp_obj_malloc(mp_obj_FatFSFile_t, &mod_detahardio_FatFSFile_type);
  f->fp = fp;
  return f;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardio_fatfs_open_obj,
                                 mod_detahardio_fatfs_open);

/// def listdir(path: str) -> FatFSDir:
///     """
///     List a directory (return generator)
///     """
STATIC mp_obj_t mod_detahardio_fatfs_listdir(mp_obj_t path) {
  FATFS_ONLY_MOUNTED;
  ...
  mp_obj_FatFSDir_t *d =
      mp_obj_malloc(mp_obj_FatFSDir_t, &mod_detahardio_FatFSDir_type);
  d->dp = dp;
  return d;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardio_fatfs_listdir_obj,
                                 mod_detahardio_fatfs_listdir);

/// def mkdir(path: str, exist_ok: bool=False) -> None:
///     """
///     Create a sub directory
///     """
STATIC mp_obj_t mod_detahardio_fatfs_mkdir(size_t n_args, const mp_obj_t *args) {
  FATFS_ONLY_MOUNTED;
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mod_detahardio_fatfs_mkdir_obj, 1, 2,
                                           mod_detahardio_fatfs_mkdir);

/// def unlink(path: str) -> None:
///     """
///     Delete an existing file or directory
///     """
STATIC mp_obj_t mod_detahardio_fatfs_unlink(mp_obj_t path) {
  FATFS_ONLY_MOUNTED;
  mp_buffer_info_t _path = {0};
  mp_get_buffer_raise(path, &_path, MP_BUFFER_READ);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardio_fatfs_unlink_obj,
                                 mod_detahardio_fatfs_unlink);

/// def stat(path: str) -> tuple[int, str, str]:
///     """
///     Get file status
///     """
STATIC mp_obj_t mod_detahardio_fatfs_stat(mp_obj_t path) {
  FATFS_ONLY_MOUNTED;
  mp_buffer_info_t _path = {0};
  mp_get_buffer_raise(path, &_path, MP_BUFFER_READ);
  FILINFO info = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardio_fatfs_stat_obj,
                                 mod_detahardio_fatfs_stat);

/// def rename(oldpath: str, newpath: str) -> None:
///     """
///     Rename/Move a file or directory
///     """
STATIC mp_obj_t mod_detahardio_fatfs_rename(mp_obj_t oldpath, mp_obj_t newpath) {
  FATFS_ONLY_MOUNTED;
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardio_fatfs_rename_obj,
                                 mod_detahardio_fatfs_rename);

/// def mount() -> None:
///     """
///     Mount the SD card filesystem.
///     """
STATIC mp_obj_t mod_detahardio_fatfs_mount() {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_detahardio_fatfs_mount_obj,
                                 mod_detahardio_fatfs_mount);

/// def unmount() -> None:
///     """
///     Unmount the SD card filesystem.
///     """
STATIC mp_obj_t mod_detahardio_fatfs_unmount() {
  _fatfs_unmount_instance();
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_detahardio_fatfs_unmount_obj,
                                 mod_detahardio_fatfs_unmount);

/// def is_mounted() -> bool:
///    """
///    Check if the filesystem is mounted.
///    """
STATIC mp_obj_t mod_detahardio_fatfs_is_mounted() {
  return mp_obj_new_bool(_fatfs_instance_is_mounted());
}
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_detahardio_fatfs_is_mounted_obj,
                                 mod_detahardio_fatfs_is_mounted);

/// def mkfs() -> None:
///     """
///     Create a FAT volume on the SD card,
///     """
STATIC mp_obj_t mod_detahardio_fatfs_mkfs() {
  if (_fatfs_instance_is_mounted()) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_detahardio_fatfs_mkfs_obj,
                                 mod_detahardio_fatfs_mkfs);

/// def setlabel(label: str) -> None:
///     """
///     Set volume label
///     """
STATIC mp_obj_t mod_detahardio_fatfs_setlabel(mp_obj_t label) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardio_fatfs_setlabel_obj,
                                 mod_detahardio_fatfs_setlabel);

STATIC const mp_rom_map_elem_t mod_detahardio_fatfs_globals_table[] = {
    {MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_fatfs)},
    {MP_ROM_QSTR(MP_QSTR_FatFSFile), MP_ROM_PTR(&mod_detahardio_FatFSFile_type)},
    {MP_ROM_QSTR(MP_QSTR_FatFSDir), MP_ROM_PTR(&mod_detahardio_FatFSDir_type)},
    ...
    {MP_ROM_QSTR(MP_QSTR_open), MP_ROM_PTR(&mod_detahardio_fatfs_open_obj)},
    {MP_ROM_QSTR(MP_QSTR_listdir), MP_ROM_PTR(&mod_detahardio_fatfs_listdir_obj)},
    {MP_ROM_QSTR(MP_QSTR_mkdir), MP_ROM_PTR(&mod_detahardio_fatfs_mkdir_obj)},
    {MP_ROM_QSTR(MP_QSTR_unlink), MP_ROM_PTR(&mod_detahardio_fatfs_unlink_obj)},
    {MP_ROM_QSTR(MP_QSTR_rename), MP_ROM_PTR(&mod_detahardio_fatfs_rename_obj)},
    {MP_ROM_QSTR(MP_QSTR_stat), MP_ROM_PTR(&mod_detahardio_fatfs_stat_obj)},
    {MP_ROM_QSTR(MP_QSTR_mount), MP_ROM_PTR(&mod_detahardio_fatfs_mount_obj)},
    {MP_ROM_QSTR(MP_QSTR_unmount), MP_ROM_PTR(&mod_detahardio_fatfs_unmount_obj)},
    {MP_ROM_QSTR(MP_QSTR_is_mounted),
     MP_ROM_PTR(&mod_detahardio_fatfs_is_mounted_obj)},
    {MP_ROM_QSTR(MP_QSTR_mkfs), MP_ROM_PTR(&mod_detahardio_fatfs_mkfs_obj)},
    {MP_ROM_QSTR(MP_QSTR_setlabel),
     MP_ROM_PTR(&mod_detahardio_fatfs_setlabel_obj)},
...
STATIC MP_DEFINE_CONST_DICT(mod_detahardio_fatfs_globals,
                            mod_detahardio_fatfs_globals_table);

STATIC const mp_obj_module_t mod_detahardio_fatfs_module = {
    .base = {&mp_type_module},
    .globals = (mp_obj_dict_t *)&mod_detahardio_fatfs_globals,
};
