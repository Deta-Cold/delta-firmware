...
from detahardlib.cardano import (
...
from detahardlib.messages import CardanoAddressType, CardanoDerivationType
...
def test_cardano_get_address(client: Client, parameters, result):
    ...
    derivation_type = CardanoDerivationType.__members__[
        parameters.get("derivation_type", "ICARUS_detahard")
    ]
