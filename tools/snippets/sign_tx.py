...
The serialized transaction can then be announced to network at https://tbtc1.detahard.io/sendtx
...
from detahardlib.debuglink import detahardClientDebugLink
...
if args.autoconfirm:
    ...
    for device in enumerate_devices():
        try:
            CLIENT = detahardClientDebugLink(device, auto_interact=True)
            break
        except Exception:
            pass
    else:
...
if args.testnet:
    COIN = "Testnet"
    URL = "https://tbtc1.detahard.io/api/tx-specific"
else:
    COIN = "Bitcoin"
    URL = "https://btc1.detahard.io/api/tx-specific"
