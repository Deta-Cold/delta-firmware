...
def test_send_p2sh(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/09144602765ce3dd8f4329445b20e3684e948709c5cdcaf12da3bb079c99448a",
...
def test_send_to_taproot(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/4f7ad10322f7d1be86ac03997cb6bcad852b8937e504de5779dfcf313edf300e",
...
def test_send_native_change(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/2161a89815814c3866f5953c1e59a977f7cd5432c731cd5633378cfc3fb87fdd",
...
def test_send_both(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/9012ec5daf9f09d79ab7ed63d1881f1e114a4ecc3754208d9254300bbdd8812e",
...
def test_send_multisig_1(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/3ec03ab3487655f88e13063b71882af5f52d1db6f622b50190035d7260517d50",
...
def test_send_multisig_2(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/2aad59bad0dd1ad3e9b2a4019bbb47c16111d5a2eddde50997e4199c26ee5882",
...
def test_send_multisig_3_change(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/16bfb04cd202a9aab41dcc3c73504f5a342345b1e1420d934a91b49c2447029d",
...
def test_send_multisig_4_change(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/b006619cf84ff4f36cfbd9a4f77a77678cc1b040d81b118c745dce5bbfe255d5",
...
def test_multisig_mismatch_inputs_single(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/d3b2ec2a540363ffbb231c6cf0a311ec84c8404c7ec2819c146dfb90a69c593a",
