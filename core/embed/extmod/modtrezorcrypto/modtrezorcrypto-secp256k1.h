...
#include "vendor/detahardrd-crypto/ecdsa.h"
#include "vendor/detahardrd-crypto/secp256k1.h"

#ifdef USE_SECP256K1_ZKP_ECDSA
#include "zkp_ecdsa.h"
#endif

/// package: detahardrdcrypto.secp256k1

/// def generate_secret() -> bytes:
///     """
///     Generate secret key.
///     """
STATIC mp_obj_t mod_detahardrdcrypto_secp256k1_generate_secret() {
  vstr_t sk = {0};
  vstr_init_len(&sk, 32);
  for (;;) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_detahardrdcrypto_secp256k1_generate_secret_obj,
                                 mod_detahardrdcrypto_secp256k1_generate_secret);

/// def publickey(secret_key: bytes, compressed: bool = True) -> bytes:
///     """
///     Computes public key from secret key.
///     """
STATIC mp_obj_t mod_detahardrdcrypto_secp256k1_publickey(size_t n_args,
                                                     const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_secp256k1_publickey_obj, 1, 2,
    mod_detahardrdcrypto_secp256k1_publickey);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_secp256k1_sign(size_t n_args,
                                                const mp_obj_t *args) {
  mp_buffer_info_t sk = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mod_detahardrdcrypto_secp256k1_sign_obj,
                                           2, 4,
                                           mod_detahardrdcrypto_secp256k1_sign);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_secp256k1_verify(mp_obj_t public_key,
                                                  mp_obj_t signature,
                                                  mp_obj_t digest) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardrdcrypto_secp256k1_verify_obj,
                                 mod_detahardrdcrypto_secp256k1_verify);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_secp256k1_verify_recover(mp_obj_t signature,
                                                          mp_obj_t digest) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_secp256k1_verify_recover_obj,
                                 mod_detahardrdcrypto_secp256k1_verify_recover);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_secp256k1_multiply(mp_obj_t secret_key,
                                                    mp_obj_t public_key) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_secp256k1_multiply_obj,
                                 mod_detahardrdcrypto_secp256k1_multiply);

STATIC const mp_rom_map_elem_t mod_detahardrdcrypto_secp256k1_globals_table[] = {
    {MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_secp256k1)},
    {MP_ROM_QSTR(MP_QSTR_generate_secret),
     MP_ROM_PTR(&mod_detahardrdcrypto_secp256k1_generate_secret_obj)},
    {MP_ROM_QSTR(MP_QSTR_publickey),
     MP_ROM_PTR(&mod_detahardrdcrypto_secp256k1_publickey_obj)},
    {MP_ROM_QSTR(MP_QSTR_sign),
     MP_ROM_PTR(&mod_detahardrdcrypto_secp256k1_sign_obj)},
    {MP_ROM_QSTR(MP_QSTR_verify),
     MP_ROM_PTR(&mod_detahardrdcrypto_secp256k1_verify_obj)},
    {MP_ROM_QSTR(MP_QSTR_verify_recover),
     MP_ROM_PTR(&mod_detahardrdcrypto_secp256k1_verify_recover_obj)},
    {MP_ROM_QSTR(MP_QSTR_multiply),
     MP_ROM_PTR(&mod_detahardrdcrypto_secp256k1_multiply_obj)},
#if !BITCOIN_ONLY
...
STATIC MP_DEFINE_CONST_DICT(mod_detahardrdcrypto_secp256k1_globals,
                            mod_detahardrdcrypto_secp256k1_globals_table);

STATIC const mp_obj_module_t mod_detahardrdcrypto_secp256k1_module = {
    .base = {&mp_type_module},
    .globals = (mp_obj_dict_t *)&mod_detahardrdcrypto_secp256k1_globals,
};
