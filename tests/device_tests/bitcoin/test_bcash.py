...
def test_send_bch_change(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://bch1.detahard.io/api/tx/502e8577b237b0152843a416f8f1ab0c63321b1be7a8cad7bf5c5c216fcf062c",
...
def test_send_bch_nochange(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://bch1.detahard.io/api/tx/5594fd9e5e26dcb4437cbbbba517401720849159bac4e2158e1e6401ffd5fdb7",
