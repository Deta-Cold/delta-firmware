...
/// package: detahardrdcrypto.monero
...
STATIC const mp_obj_type_t mod_detahardrdcrypto_monero_ge25519_type;
STATIC const mp_obj_type_t mod_detahardrdcrypto_monero_bignum256modm_type;
STATIC const mp_obj_type_t mod_detahardrdcrypto_monero_hasher_type;

#define MP_OBJ_IS_GE25519(o) \
  MP_OBJ_IS_TYPE((o), &mod_detahardrdcrypto_monero_ge25519_type)
#define MP_OBJ_IS_SCALAR(o) \
  MP_OBJ_IS_TYPE((o), &mod_detahardrdcrypto_monero_bignum256modm_type)
...
STATIC mp_obj_t mp_obj_new_scalar() {
  ...
  o->base.type = &mod_detahardrdcrypto_monero_bignum256modm_type;
  set256_modm(o->p, 0);
...
STATIC mp_obj_t mp_obj_new_ge25519() {
  ...
  o->base.type = &mod_detahardrdcrypto_monero_ge25519_type;
...
STATIC mp_obj_t mod_detahardrdcrypto_monero_ge25519_make_new(
...
STATIC mp_obj_t mod_detahardrdcrypto_monero_ge25519___del__(mp_obj_t self) {
  mp_obj_ge25519_t *o = MP_OBJ_TO_PTR(self);
  memzero(&(o->p), sizeof(ge25519));
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardrdcrypto_monero_ge25519___del___obj,
                                 mod_detahardrdcrypto_monero_ge25519___del__);
...
///
///
STATIC mp_obj_t mod_detahardrdcrypto_monero_bignum256modm_make_new(
    const mp_obj_type_t *type, size_t n_args, size_t n_kw,
    const mp_obj_t *args) {
  mp_arg_check_num(n_args, n_kw, 0, 1, false);
  mp_obj_bignum256modm_t *o = m_new_obj_with_finaliser(mp_obj_bignum256modm_t);
  ...
  if (n_args == 0 || args[0] == mp_const_none) {
    ...
    uint64_t v = detahardrd_obj_get_uint64(args[0]);
    set256_modm(o->p, v);
  } else {
...
STATIC mp_obj_t mod_detahardrdcrypto_monero_bignum256modm___del__(mp_obj_t self) {
  mp_obj_bignum256modm_t *o = MP_OBJ_TO_PTR(self);
  memzero(o->p, sizeof(bignum256modm));
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_detahardrdcrypto_monero_bignum256modm___del___obj,
    mod_detahardrdcrypto_monero_bignum256modm___del__);
...
///
///
STATIC mp_obj_t mod_detahardrdcrypto_monero_hasher_make_new(
    const mp_obj_type_t *type, size_t n_args, size_t n_kw,
    const mp_obj_t *args) {
  mp_arg_check_num(n_args, n_kw, 0, 1, false);
...
STATIC mp_obj_t mod_detahardrdcrypto_monero_hasher___del__(mp_obj_t self) {
  mp_obj_hasher_t *o = MP_OBJ_TO_PTR(self);
  memzero(&(o->h), sizeof(Hasher));
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardrdcrypto_monero_hasher___del___obj,
                                 mod_detahardrdcrypto_monero_hasher___del__);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_copy(const mp_obj_t dest,
                                                const mp_obj_t src) {
  ...
  if (MP_OBJ_IS_SCALAR(src)) {
    ...
    uint64_t v = detahardrd_obj_get_uint64(src);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_monero_sc_copy_obj,
                                 mod_detahardrdcrypto_monero_sc_copy);

/// def sc_check(val: Scalar) -> None:
///     """
///     Throws exception if scalar is invalid
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_check(const mp_obj_t arg) {
  assert_scalar(arg);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardrdcrypto_monero_sc_check_obj,
                                 mod_detahardrdcrypto_monero_sc_check);

/// def sc_iszero(val: Scalar) -> bool:
///     """
///     Returns False if the scalar is zero
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_iszero(const mp_obj_t arg) {
  assert_scalar(arg);
  const int r = iszero256_modm(MP_OBJ_C_SCALAR(arg));
  return mp_obj_new_int(r);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardrdcrypto_monero_sc_iszero_obj,
                                 mod_detahardrdcrypto_monero_sc_iszero);

/// def sc_eq(a: Scalar, b: Scalar) -> int:
///     """
///     Compares scalars, returns 1 on the same value
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_eq(const mp_obj_t a,
                                              const mp_obj_t b) {
  assert_scalar(a);
  assert_scalar(b);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_monero_sc_eq_obj,
                                 mod_detahardrdcrypto_monero_sc_eq);

/// def sc_add_into(r: Scalar | None, a: Scalar, b: Scalar) -> Scalar:
///     """
///     Scalar addition
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_add_into(const mp_obj_t dest,
                                                    const mp_obj_t a,
                                                    const mp_obj_t b) {
  mp_obj_t res = mp_obj_new_scalar_r(dest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardrdcrypto_monero_sc_add_into_obj,
                                 mod_detahardrdcrypto_monero_sc_add_into);

/// def sc_sub_into(r: Scalar | None, a: Scalar, b: Scalar) -> Scalar:
///     """
///     Scalar subtraction
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_sub_into(const mp_obj_t dest,
                                                    const mp_obj_t a,
                                                    const mp_obj_t b) {
  mp_obj_t res = mp_obj_new_scalar_r(dest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardrdcrypto_monero_sc_sub_into_obj,
                                 mod_detahardrdcrypto_monero_sc_sub_into);

/// def sc_mul_into(r: Scalar | None, a: Scalar, b: Scalar) -> Scalar:
///     """
///     Scalar multiplication
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_mul_into(const mp_obj_t dest,
                                                    const mp_obj_t a,
                                                    const mp_obj_t b) {
  mp_obj_t res = mp_obj_new_scalar_r(dest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardrdcrypto_monero_sc_mul_into_obj,
                                 mod_detahardrdcrypto_monero_sc_mul_into);
...
///     c - a*b
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_mulsub_into(size_t n_args,
                                                       const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_sc_mulsub_into_obj, 4, 4,
    mod_detahardrdcrypto_monero_sc_mulsub_into);
...
///     c + a*b
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_muladd_into(size_t n_args,
                                                       const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 4, 4, false);
  mp_obj_t res = mp_obj_new_scalar_r(args[0]);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_sc_muladd_into_obj, 4, 4,
    mod_detahardrdcrypto_monero_sc_muladd_into);

/// def sc_inv_into(r: Scalar | None, a: Scalar) -> Scalar:
///     """
///     Scalar modular inversion
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_sc_inv_into(const mp_obj_t dest,
                                                    const mp_obj_t arg) {
  mp_obj_t res = mp_obj_new_scalar_r(dest);
  assert_scalar(arg);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_monero_sc_inv_into_obj,
                                 mod_detahardrdcrypto_monero_sc_inv_into);
...
///     Scalar compression
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_encodeint_into(size_t n_args,
                                                       const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_encodeint_into_obj, 2, 3,
    mod_detahardrdcrypto_monero_encodeint_into);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_decodeint_into(size_t n_args,
                                                       const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 2, 3, false);
  mp_obj_t res = mp_obj_new_scalar_r(args[0]);
  const mp_int_t offset = n_args >= 3 ? mp_obj_get_int(args[2]) : 0;
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_decodeint_into_obj, 2, 3,
    mod_detahardrdcrypto_monero_decodeint_into);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_decodeint_into_noreduce(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_decodeint_into_noreduce_obj, 2, 3,
    mod_detahardrdcrypto_monero_decodeint_into_noreduce);
...
///     Sets neutral point
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_identity_into(size_t n_args,
                                                      const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_identity_into_obj, 0, 1,
    mod_detahardrdcrypto_monero_identity_into);

/// def xmr_H(r: Point | None = None) -> Point:
///     """
///     Sets H point
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_xmr_H(size_t n_args,
                                              const mp_obj_t *args) {
  mp_obj_t res = mp_obj_new_ge25519_r(n_args == 1 ? args[0] : mp_const_none);
  ge25519_set_xmr_h(&MP_OBJ_GE25519(res));
  return res;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mod_detahardrdcrypto_monero_xmr_H_obj, 0,
                                           1, mod_detahardrdcrypto_monero_xmr_H);

/// def ge25519_check(r: Point) -> None:
///     """
///     Checks point, throws if not on curve
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_ge25519_check(const mp_obj_t arg) {
  assert_ge25519(arg);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardrdcrypto_monero_ge25519_check_obj,
                                 mod_detahardrdcrypto_monero_ge25519_check);

/// def point_eq(a: Point, b: Point) -> bool:
///     """
///     Compares EC points
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_point_eq(const mp_obj_t a,
                                                 const mp_obj_t b) {
  assert_ge25519(a);
  assert_ge25519(b);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_monero_point_eq_obj,
                                 mod_detahardrdcrypto_monero_point_eq);

/// def point_add_into(r: Point | None, a: Point, b: Point) -> Point:
///     """
///     Adds EC points
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_point_add_into(const mp_obj_t dest,
                                                       const mp_obj_t a,
                                                       const mp_obj_t b) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardrdcrypto_monero_point_add_into_obj,
                                 mod_detahardrdcrypto_monero_point_add_into);

/// def point_sub_into(r: Point | None, a: Point, b: Point) -> Point:
///     """
///     Subtracts EC points
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_point_sub_into(const mp_obj_t dest,
                                                       const mp_obj_t a,
                                                       const mp_obj_t b) {
  mp_obj_t res = mp_obj_new_ge25519_r(dest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardrdcrypto_monero_point_sub_into_obj,
                                 mod_detahardrdcrypto_monero_point_sub_into);

/// def ge25519_mul8(r: Point | None, p: Point) -> Point:
///     """
///     EC point * 8
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_ge25519_mul8(const mp_obj_t dest,
                                                     const mp_obj_t src) {
  mp_obj_t res = mp_obj_new_ge25519_r(dest);
  assert_ge25519(src);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_monero_ge25519_mul8_obj,
                                 mod_detahardrdcrypto_monero_ge25519_mul8);
...
///     s1 * G + s2 * p1
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_ge25519_double_scalarmult_vartime_into(
    size_t n_args, const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 4, 4, false);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_ge25519_double_scalarmult_vartime_into_obj, 4, 4,
    mod_detahardrdcrypto_monero_ge25519_double_scalarmult_vartime_into);
...
///     s * G
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_scalarmult_base_into(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_detahardrdcrypto_monero_scalarmult_base_into_obj,
    mod_detahardrdcrypto_monero_scalarmult_base_into);
...
///     s * p
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_scalarmult_into(const mp_obj_t dest,
                                                        const mp_obj_t p,
                                                        const mp_obj_t s) {
  mp_obj_t res = mp_obj_new_ge25519_r(dest);
  assert_ge25519(p);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardrdcrypto_monero_scalarmult_into_obj,
                                 mod_detahardrdcrypto_monero_scalarmult_into);

/// def encodepoint_into(r: bytes | None, p: Point, offset: int = 0) -> bytes:
///     """
///     Point compression
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_encodepoint_into(size_t n_args,
                                                         const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 2, 3, false);
  if (args[0] == mp_const_none) {
    assert_ge25519(args[1]);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_encodepoint_into_obj, 2, 3,
    mod_detahardrdcrypto_monero_encodepoint_into);
...
///     Point decompression
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_decodepoint_into(size_t n_args,
                                                         const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 2, 3, false);
  mp_obj_t res = mp_obj_new_ge25519_r(args[0]);
  const mp_int_t offset = n_args >= 3 ? mp_obj_get_int(args[2]) : 0;
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_decodepoint_into_obj, 2, 3,
    mod_detahardrdcrypto_monero_decodepoint_into);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_xmr_base58_addr_encode_check(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_detahardrdcrypto_monero_xmr_base58_addr_encode_check_obj,
    mod_detahardrdcrypto_monero_xmr_base58_addr_encode_check);
...
///     """
STATIC mp_obj_t
mod_detahardrdcrypto_monero_xmr_base58_addr_decode_check(const mp_obj_t buff) {
  uint64_t tag = 0;
  vstr_t out = {0};
  vstr_init_len(&out, 128);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_detahardrdcrypto_monero_xmr_base58_addr_decode_check_obj,
    mod_detahardrdcrypto_monero_xmr_base58_addr_decode_check);

/// def random_scalar(r: Scalar | None = None) -> Scalar:
///     """
///     Generates a random scalar
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_random_scalar(size_t n_args,
                                                      const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_random_scalar_obj, 0, 1,
    mod_detahardrdcrypto_monero_random_scalar);
...
///     XMR fast hash
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_fast_hash_into(size_t n_args,
                                                       const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_fast_hash_into_obj, 2, 4,
    mod_detahardrdcrypto_monero_fast_hash_into);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_hash_to_point_into(
    size_t n_args, const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 2, 4, false);
  mp_obj_t res = mp_obj_new_ge25519_r(args[0]);
  mp_buffer_info_t data = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_hash_to_point_into_obj, 2, 4,
    mod_detahardrdcrypto_monero_hash_to_point_into);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_hash_to_scalar_into(
    size_t n_args, const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 2, 4, false);
  mp_obj_t res = mp_obj_new_scalar_r(args[0]);
  mp_buffer_info_t data = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_hash_to_scalar_into_obj, 2, 4,
    mod_detahardrdcrypto_monero_hash_to_scalar_into);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_xmr_derivation_to_scalar(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(
    mod_detahardrdcrypto_monero_xmr_derivation_to_scalar_obj,
    mod_detahardrdcrypto_monero_xmr_derivation_to_scalar);
...
///     8*(key2*key1)
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_xmr_generate_key_derivation(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(
    mod_detahardrdcrypto_monero_xmr_generate_key_derivation_obj,
    mod_detahardrdcrypto_monero_xmr_generate_key_derivation);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_xmr_derive_private_key(
    size_t n_args, const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 4, 4, false);
  mp_obj_t res = mp_obj_new_scalar_r(args[0]);
  assert_ge25519(args[1]);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_xmr_derive_private_key_obj, 4, 4,
    mod_detahardrdcrypto_monero_xmr_derive_private_key);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_xmr_derive_public_key(
    size_t n_args, const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 4, 4, false);
  mp_obj_t res = mp_obj_new_ge25519_r(args[0]);
  assert_ge25519(args[1]);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_xmr_derive_public_key_obj, 4, 4,
    mod_detahardrdcrypto_monero_xmr_derive_public_key);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_add_keys2_into(size_t n_args,
                                                       const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 4, 4, false);
  mp_obj_t res = mp_obj_new_ge25519_r(args[0]);
  assert_scalar(args[1]);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_add_keys2_into_obj, 4, 4,
    mod_detahardrdcrypto_monero_add_keys2_into);
...
///     aA + bB
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_add_keys3_into(size_t n_args,
                                                       const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_add_keys3_into_obj, 5, 5,
    mod_detahardrdcrypto_monero_add_keys3_into);
...
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_xmr_get_subaddress_secret_key(
    size_t n_args, const mp_obj_t *args) {
  mp_arg_check_num(n_args, 0, 4, 4, false);
  mp_obj_t res = mp_obj_new_scalar_r(args[0]);
  assert_scalar(args[3]);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_xmr_get_subaddress_secret_key_obj, 4, 4,
    mod_detahardrdcrypto_monero_xmr_get_subaddress_secret_key);

/// def gen_commitment_into(r: Point | None, a: Scalar, amount: int) -> Point:
///     """
///     aG + amount * H
///     """
STATIC mp_obj_t mod_detahardrdcrypto_monero_gen_commitment_into(
    const mp_obj_t dest, const mp_obj_t a, const mp_obj_t amount) {
  mp_obj_t res = mp_obj_new_ge25519_r(dest);
  assert_scalar(a);
  xmr_gen_c(&MP_OBJ_GE25519(res), MP_OBJ_C_SCALAR(a),
            detahardrd_obj_get_uint64(amount));
  return res;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_3(
    mod_detahardrdcrypto_monero_gen_commitment_into_obj,
    mod_detahardrdcrypto_monero_gen_commitment_into);

/// def ct_equals(a: bytes, b: bytes) -> bool:
///     """
///     Constant time buffer comparison
///     """
STATIC mp_obj_t mod_detahardrdcrypto_ct_equals(const mp_obj_t a, const mp_obj_t b) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_ct_equals_obj,
                                 mod_detahardrdcrypto_ct_equals);

// Hasher
STATIC mp_obj_t mod_detahardrdcrypto_monero_hasher_update(mp_obj_t self,
                                                      const mp_obj_t arg) {
  mp_obj_hasher_t *o = MP_OBJ_TO_PTR(self);
  mp_buffer_info_t buff = {0};
  mp_get_buffer_raise(arg, &buff, MP_BUFFER_READ);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_detahardrdcrypto_monero_hasher_update_obj,
                                 mod_detahardrdcrypto_monero_hasher_update);

STATIC mp_obj_t mod_detahardrdcrypto_monero_hasher_digest(size_t n_args,
                                                      const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardrdcrypto_monero_hasher_digest_obj, 1, 3,
    mod_detahardrdcrypto_monero_hasher_digest);

STATIC mp_obj_t mod_detahardrdcrypto_monero_hasher_copy(mp_obj_t self) {
  mp_obj_hasher_t *o = MP_OBJ_TO_PTR(self);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardrdcrypto_monero_hasher_copy_obj,
                                 mod_detahardrdcrypto_monero_hasher_copy);
...
STATIC const mp_rom_map_elem_t
    mod_detahardrdcrypto_monero_ge25519_locals_dict_table[] = {
        {MP_ROM_QSTR(MP_QSTR___del__),
         MP_ROM_PTR(&mod_detahardrdcrypto_monero_ge25519___del___obj)},
};
STATIC MP_DEFINE_CONST_DICT(mod_detahardrdcrypto_monero_ge25519_locals_dict,
                            mod_detahardrdcrypto_monero_ge25519_locals_dict_table);

STATIC const mp_obj_type_t mod_detahardrdcrypto_monero_ge25519_type = {
    {&mp_type_type},
    .name = MP_QSTR_Point,
    .make_new = mod_detahardrdcrypto_monero_ge25519_make_new,
    .locals_dict = (void *)&mod_detahardrdcrypto_monero_ge25519_locals_dict,
};

STATIC const mp_rom_map_elem_t
    mod_detahardrdcrypto_monero_bignum256modm_locals_dict_table[] = {
        {MP_ROM_QSTR(MP_QSTR___del__),
         MP_ROM_PTR(&mod_detahardrdcrypto_monero_bignum256modm___del___obj)},
};
STATIC MP_DEFINE_CONST_DICT(
    mod_detahardrdcrypto_monero_bignum256modm_locals_dict,
    mod_detahardrdcrypto_monero_bignum256modm_locals_dict_table);

STATIC const mp_obj_type_t mod_detahardrdcrypto_monero_bignum256modm_type = {
    {&mp_type_type},
    .name = MP_QSTR_Scalar,
    .make_new = mod_detahardrdcrypto_monero_bignum256modm_make_new,
    .locals_dict = (void *)&mod_detahardrdcrypto_monero_bignum256modm_locals_dict,
};

STATIC const mp_rom_map_elem_t
    mod_detahardrdcrypto_monero_hasher_locals_dict_table[] = {
        {MP_ROM_QSTR(MP_QSTR_update),
         MP_ROM_PTR(&mod_detahardrdcrypto_monero_hasher_update_obj)},
        {MP_ROM_QSTR(MP_QSTR_digest),
         MP_ROM_PTR(&mod_detahardrdcrypto_monero_hasher_digest_obj)},
        {MP_ROM_QSTR(MP_QSTR_copy),
         MP_ROM_PTR(&mod_detahardrdcrypto_monero_hasher_copy_obj)},
        {MP_ROM_QSTR(MP_QSTR___del__),
         MP_ROM_PTR(&mod_detahardrdcrypto_monero_hasher___del___obj)},
...
STATIC MP_DEFINE_CONST_DICT(mod_detahardrdcrypto_monero_hasher_locals_dict,
                            mod_detahardrdcrypto_monero_hasher_locals_dict_table);

STATIC const mp_obj_type_t mod_detahardrdcrypto_monero_hasher_type = {
    {&mp_type_type},
    .name = MP_QSTR_hasher,
    .make_new = mod_detahardrdcrypto_monero_hasher_make_new,
    .locals_dict = (void *)&mod_detahardrdcrypto_monero_hasher_locals_dict,
};

/// BP_GI_PLUS_PRE: bytes
STATIC const mp_obj_str_t mod_detahardrdcrypto_monero_BP_PLUS_GI_PRE_obj = {{&mp_type_bytes}, 0, 8192, (const byte*)""
...
STATIC const mp_obj_str_t mod_detahardrdcrypto_monero_BP_PLUS_HI_PRE_obj = {{&mp_type_bytes}, 0, 8192, (const byte*)""
...
STATIC const mp_rom_map_elem_t mod_detahardrdcrypto_monero_globals_table[] = {
    {MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_monero)},
    // types
    {MP_ROM_QSTR(MP_QSTR_Point),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_ge25519_type)},
    {MP_ROM_QSTR(MP_QSTR_Scalar),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_bignum256modm_type)},
    // functions
    {MP_ROM_QSTR(MP_QSTR_sc_copy),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_copy_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_check),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_check_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_iszero),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_iszero_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_eq),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_eq_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_add_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_add_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_sub_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_sub_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_mul_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_mul_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_mulsub_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_mulsub_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_muladd_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_muladd_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_sc_inv_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_sc_inv_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_encodeint_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_encodeint_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_decodeint_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_decodeint_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_decodeint_into_noreduce),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_decodeint_into_noreduce_obj)},
    {MP_ROM_QSTR(MP_QSTR_identity_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_identity_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_H),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_xmr_H_obj)},
    {MP_ROM_QSTR(MP_QSTR_encodepoint_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_encodepoint_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_decodepoint_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_decodepoint_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_ge25519_check),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_ge25519_check_obj)},
    {MP_ROM_QSTR(MP_QSTR_point_eq),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_point_eq_obj)},
    {MP_ROM_QSTR(MP_QSTR_point_add_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_point_add_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_point_sub_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_point_sub_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_ge25519_mul8),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_ge25519_mul8_obj)},
    {MP_ROM_QSTR(MP_QSTR_ge25519_double_scalarmult_vartime_into),
     MP_ROM_PTR(
         &mod_detahardrdcrypto_monero_ge25519_double_scalarmult_vartime_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_scalarmult_base_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_scalarmult_base_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_scalarmult_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_scalarmult_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_base58_addr_encode_check),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_xmr_base58_addr_encode_check_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_base58_addr_decode_check),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_xmr_base58_addr_decode_check_obj)},
    {MP_ROM_QSTR(MP_QSTR_random_scalar),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_random_scalar_obj)},
    {MP_ROM_QSTR(MP_QSTR_fast_hash_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_fast_hash_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_hash_to_point_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_hash_to_point_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_hash_to_scalar_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_hash_to_scalar_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_derivation_to_scalar),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_xmr_derivation_to_scalar_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_generate_key_derivation),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_xmr_generate_key_derivation_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_derive_private_key),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_xmr_derive_private_key_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_derive_public_key),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_xmr_derive_public_key_obj)},
    {MP_ROM_QSTR(MP_QSTR_add_keys2_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_add_keys2_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_add_keys3_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_add_keys3_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_xmr_get_subaddress_secret_key),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_xmr_get_subaddress_secret_key_obj)},
    {MP_ROM_QSTR(MP_QSTR_gen_commitment_into),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_gen_commitment_into_obj)},
    {MP_ROM_QSTR(MP_QSTR_ct_equals),
     MP_ROM_PTR(&mod_detahardrdcrypto_ct_equals_obj)},
    // bulletproof constants
    {MP_ROM_QSTR(MP_QSTR_BP_PLUS_GI_PRE),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_BP_PLUS_GI_PRE_obj)},
    {MP_ROM_QSTR(MP_QSTR_BP_PLUS_HI_PRE),
     MP_ROM_PTR(&mod_detahardrdcrypto_monero_BP_PLUS_HI_PRE_obj)},
};
STATIC MP_DEFINE_CONST_DICT(mod_detahardrdcrypto_monero_globals,
                            mod_detahardrdcrypto_monero_globals_table);

STATIC const mp_obj_module_t mod_detahardrdcrypto_monero_module = {
    .base = {&mp_type_module},
    .globals = (mp_obj_dict_t *)&mod_detahardrdcrypto_monero_globals,
};
