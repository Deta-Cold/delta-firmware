...
if not utils.BITCOIN_ONLY:
    from detahard.messages import NEMAggregateModification
    from detahard.messages import NEMCosignatoryModification
    from detahard.messages import NEMSignTx
    from detahard.messages import NEMTransactionCommon
