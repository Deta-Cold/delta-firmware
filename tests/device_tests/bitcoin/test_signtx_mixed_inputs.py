...
def test_non_segwit_segwit_inputs(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/e4b3150748dfaad0df9b55aadf13a231a0c84baf0f5be56a704375c0ee5f873b",
...
def test_segwit_non_segwit_inputs(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/15611ef30e38a23620462ef0199003c3cbc5902216b0150420fb63ec094e8fe7",
...
def test_segwit_non_segwit_segwit_inputs(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/5ff5ddaa28241353a714bbcc57ce86a6cf1caf31d33948c62da2f55dadb2533b",
...
def test_non_segwit_segwit_non_segwit_inputs(client: Client):
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://tbtc1.detahard.io/api/tx/af4b1333244958e380cdd50f8fbb11530bc80208ddb8e8d5b35ebd51c0f486be",
