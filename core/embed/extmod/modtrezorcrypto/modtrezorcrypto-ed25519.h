...
/// package: detahardcrypto.ed25519

/// def generate_secret() -> bytes:
///     """
///     Generate secret key.
///     """
STATIC mp_obj_t mod_detahardcrypto_ed25519_generate_secret() {
  vstr_t sk = {0};
  vstr_init_len(&sk, 32);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_detahardcrypto_ed25519_generate_secret_obj,
                                 mod_detahardcrypto_ed25519_generate_secret);

/// def publickey(secret_key: bytes) -> bytes:
///     """
///     Computes public key from secret key.
///     """
STATIC mp_obj_t mod_detahardcrypto_ed25519_publickey(mp_obj_t secret_key) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_detahardcrypto_ed25519_publickey_obj,
                                 mod_detahardcrypto_ed25519_publickey);

/// def sign(secret_key: bytes, message: bytes, hasher: str = "") -> bytes:
///     """
///     Uses secret key to produce the signature of message.
///     """
STATIC mp_obj_t mod_detahardcrypto_ed25519_sign(size_t n_args,
                                              const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mod_detahardcrypto_ed25519_sign_obj, 2,
                                           3, mod_detahardcrypto_ed25519_sign);
...
///     """
STATIC mp_obj_t mod_detahardcrypto_ed25519_sign_ext(mp_obj_t secret_key,
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardcrypto_ed25519_sign_ext_obj,
                                 mod_detahardcrypto_ed25519_sign_ext);
...
///     """
STATIC mp_obj_t mod_detahardcrypto_ed25519_verify(mp_obj_t public_key,
                                                mp_obj_t signature,
                                                mp_obj_t message) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_detahardcrypto_ed25519_verify_obj,
                                 mod_detahardcrypto_ed25519_verify);
...
///     """
STATIC mp_obj_t
mod_detahardcrypto_ed25519_cosi_combine_publickeys(mp_obj_t public_keys) {
  size_t pklen = 0;
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_detahardcrypto_ed25519_cosi_combine_publickeys_obj,
    mod_detahardcrypto_ed25519_cosi_combine_publickeys);
...
///     """
STATIC mp_obj_t mod_detahardcrypto_ed25519_cosi_combine_signatures(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_detahardcrypto_ed25519_cosi_combine_signatures_obj,
    mod_detahardcrypto_ed25519_cosi_combine_signatures);

/// def cosi_commit() -> tuple[bytes, bytes]:
///     """
///     Generate a nonce and commitment for the CoSi cosigning scheme.
///     """
STATIC mp_obj_t mod_detahardcrypto_ed25519_cosi_commit() {
  vstr_t nonce = {0};
  vstr_t commitment = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_detahardcrypto_ed25519_cosi_commit_obj,
                                 mod_detahardcrypto_ed25519_cosi_commit);
...
///     """
STATIC mp_obj_t mod_detahardcrypto_ed25519_cosi_sign(size_t n_args,
                                                   const mp_obj_t *args) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_detahardcrypto_ed25519_cosi_sign_obj, 5, 5,
    mod_detahardcrypto_ed25519_cosi_sign);

STATIC const mp_rom_map_elem_t mod_detahardcrypto_ed25519_globals_table[] = {
    {MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_ed25519)},
    {MP_ROM_QSTR(MP_QSTR_generate_secret),
     MP_ROM_PTR(&mod_detahardcrypto_ed25519_generate_secret_obj)},
    {MP_ROM_QSTR(MP_QSTR_publickey),
     MP_ROM_PTR(&mod_detahardcrypto_ed25519_publickey_obj)},
    {MP_ROM_QSTR(MP_QSTR_sign), MP_ROM_PTR(&mod_detahardcrypto_ed25519_sign_obj)},
#if !BITCOIN_ONLY
    {MP_ROM_QSTR(MP_QSTR_sign_ext),
     MP_ROM_PTR(&mod_detahardcrypto_ed25519_sign_ext_obj)},
#endif
    {MP_ROM_QSTR(MP_QSTR_verify),
     MP_ROM_PTR(&mod_detahardcrypto_ed25519_verify_obj)},
    {MP_ROM_QSTR(MP_QSTR_cosi_combine_publickeys),
     MP_ROM_PTR(&mod_detahardcrypto_ed25519_cosi_combine_publickeys_obj)},
    {MP_ROM_QSTR(MP_QSTR_cosi_combine_signatures),
     MP_ROM_PTR(&mod_detahardcrypto_ed25519_cosi_combine_signatures_obj)},
    {MP_ROM_QSTR(MP_QSTR_cosi_commit),
     MP_ROM_PTR(&mod_detahardcrypto_ed25519_cosi_commit_obj)},
    {MP_ROM_QSTR(MP_QSTR_cosi_sign),
     MP_ROM_PTR(&mod_detahardcrypto_ed25519_cosi_sign_obj)},
};
STATIC MP_DEFINE_CONST_DICT(mod_detahardcrypto_ed25519_globals,
                            mod_detahardcrypto_ed25519_globals_table);

STATIC const mp_obj_module_t mod_detahardcrypto_ed25519_module = {
    .base = {&mp_type_module},
    .globals = (mp_obj_dict_t *)&mod_detahardcrypto_ed25519_globals,
};
